  ...
  return (
    <section data-snap-section className="relative min-h-[100svh] flex flex-col justify-between pt-28 pb-12 px-6 md:px-10 lg:px-16 overflow-visible z-10">
      ...
      <div className="relative z-10 w-full flex-1 flex flex-col">
        <PageHero
          title="Services"
          subtitle="From apps and websites to CMS platforms, user experience, brand design, and automated workflows, we bring every part of your digital project together under one roof."
          layout="split"
          spread
          showDot
        ...
        >
          <ServiceCard imageRef={previewImageRef} />
        </PageHero>
      </div>
